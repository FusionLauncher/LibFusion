...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Jul 20 22:22:10 2015
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LibFusion1.0.0/ && $(COPY_FILE) --parents libfusion.h libfusion_global.h fgame.h fdb.h flibrary.h fcrawler.h fartmanager.h ffiledownloader.h thegamedbstorage.h fclientupdater.h .tmp/LibFusion1.0.0/ && $(COPY_FILE) --parents libfusion.cpp fgame.cpp fdb.cpp flibrary.cpp fcrawler.cpp fartmanager.cpp ffiledownloader.cpp fclientupdater.cpp .tmp/LibFusion1.0.0/ && (cd `dirname .tmp/LibFusion1.0.0` && $(TAR) LibFusion1.0.0.tar LibFusion1.0.0 && $(COMPRESS) LibFusion1.0.0.tar) && $(MOVE) `dirname .tmp/LibFusion1.0.0`/LibFusion1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LibFusion1.0.0
...
compiler_moc_header_make_all: moc_flibrary.cpp moc_fartmanager.cpp moc_ffiledownloader.cpp moc_fclientupdater.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_flibrary.cpp moc_fartmanager.cpp moc_ffiledownloader.cpp moc_fclientupdater.cpp
...
moc_fclientupdater.cpp: ffiledownloader.h \
		fclientupdater.h
